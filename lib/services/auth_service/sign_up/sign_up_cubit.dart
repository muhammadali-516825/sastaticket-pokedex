...
import 'package:sastaticket_pokedex/utils/auth_models/email.dart';
import 'package:sastaticket_pokedex/utils/auth_models/name.dart';
import 'package:sastaticket_pokedex/utils/auth_models/password.dart';
import 'package:sastaticket_pokedex/utils/auth_models/re_password.dart';
...
class SignUpCubit extends Cubit<SignUpState> {
  ...
  void signUpWithCredentials() async {
    try {
      ...
      emit(state.copyWith(status: FormzStatus.submissionSuccess, isSignedUp: true));
